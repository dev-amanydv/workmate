      ...
      <div className="h-full overflow-y-auto no-scrollbar py-6 px-1 min-w-0 flex flex-col gap-6">
        ...
        <div className="flex items-center gap-1 sm:gap-2 border-b border-[#E6E5E0] px-1">
          ...
          <button
            ...
            className={`group relative flex items-center gap-2 pb-3 pt-1 px-3 text-sm font-semibold transition cursor-pointer ${
              activeTab === "posts"
                ? "text-[#184A45] after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-[#184A45] after:rounded-full"
          ...
          >
            <svg
              className={`w-4 h-4 shrink-0 transition-colors ${
                activeTab === "posts"
                  ? "text-[#184A45]"
                  : "text-[#8A8D90] group-hover:text-[#17191A]"
              }`}
              fill="none"
              stroke="currentColor"
              strokeWidth={1.75}
            ...
            <span
              className={`rounded-full px-2 py-0.5 text-xs font-semibold transition-colors ${
                activeTab === "posts"
                  ...
                  : "bg-[#F5F4F0] text-[#6C6F71] group-hover:bg-[#EFEFEA] group-hover:text-[#17191A]"
              }`}
            >
              {postsCount}
            </span>
